...
public class Serie {
    private String poster_path,backdrop_path,adult,overview,release_date,id,title,vote_count,vote_average,original_language,trailer,episode_run_time,number_of_episodes,number_of_seasons,status;
